            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('postassettype')}}" method="post">
                        @csrf()
                      <div class="form-group">
                        <label for="exampleInputName1">Asset Type</label>
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="Asset Type" name="asset_type">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="asset_description"></textarea>
                      </div>
